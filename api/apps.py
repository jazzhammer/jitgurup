...
class ApiConfig(AppConfig):
    ...
    def confirm_default_subjects(self):
        ...
        math_tech = self.confirm_default_subject('Math & Technology')

        self.confirm_default_topic(math_tech,'positive and negative exponents')
        self.confirm_default_topic(math_tech,'exponent laws')
        self.confirm_default_topic(math_tech,'evaluation using order of operations')
        self.confirm_default_topic(math_tech,'numerical and variable bases')
        self.confirm_default_topic(math_tech,'expressing prime factorization of a number using powers')
        self.confirm_default_topic(math_tech,'identifying the factors of a number')
        self.confirm_default_topic(math_tech,'includes greatest common factor (GCF) and least common multiple (LCM)')
        self.confirm_default_topic(math_tech,'strategies include using factor trees and factor pairs')
        self.confirm_default_topic(math_tech,'communicating domain and range in both situational and non-situational contexts')
        self.confirm_default_topic(math_tech,'connecting graphs and context')
        self.confirm_default_topic(math_tech,'understanding the meaning of a function')
        self.confirm_default_topic(math_tech,'identifying whether a relation is a function')
        self.confirm_default_topic(math_tech,'using function notation')
        self.confirm_default_topic(math_tech,'slope: positive, negative, zero, and undefined')
        self.confirm_default_topic(math_tech,'types of equations of lines (point-slope, slope intercept, and general)')
        self.confirm_default_topic(math_tech,'equations of parallel and perpendicular lines')
        self.confirm_default_topic(math_tech,'equations of horizontal and vertical lines')
        self.confirm_default_topic(math_tech,'connections between representations: graphs, tables, equations')
        self.confirm_default_topic(math_tech,'applying formal language (common difference, first term, general term) to increasing and decreasing linear patterns')
        self.confirm_default_topic(math_tech,'connecting to linear relations')
        self.confirm_default_topic(math_tech,'extension: exploring arithmetic series')
        self.confirm_default_topic(math_tech,'solving graphically')
        self.confirm_default_topic(math_tech,'solving algebraically by inspection, substitution, elimination')
        self.confirm_default_topic(math_tech,'connecting ordered pair with meaning of an algebraic solution')
        self.confirm_default_topic(math_tech,'solving problems in situational contexts')
        self.confirm_default_topic(math_tech,'applying the distributive property between two polynomials, including trinomials')
        self.confirm_default_topic(math_tech,'connecting the product of binomials with an area model')
        self.confirm_default_topic(math_tech,'greatest common factor of a polynomial')
        self.confirm_default_topic(math_tech,'simpler cases involving trinomials y = x2 + bx + c and difference of squares')
        self.confirm_default_topic(math_tech,'sine, cosine, and tangent ratios')
        self.confirm_default_topic(math_tech,'right-triangle problems: determining missing sides and/or angles using trigonometric ratios and the Pythagorean theorem')
        self.confirm_default_topic(math_tech,'contexts involving direct and indirect measurement')
        self.confirm_default_topic(math_tech,'types of income')
        self.confirm_default_topic(math_tech,'income tax and other deductions')
